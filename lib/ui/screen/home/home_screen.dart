            ...
            child: GestureDetector(
              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    requestRouter.url(AccountConfig.userDetail.user.profile_image),
                    fit: BoxFit.cover,
              ...
              Row(
                ...
                children: [
                  Text(today.day.toString(),
                      style: const TextStyle(color: Color(0xff000000), fontWeight: FontWeight.w700, fontStyle: FontStyle.normal, fontSize: 36.0),
                      textAlign: TextAlign.center),
                  SizedBox(
                    width: 2.w,
                  ),
                  Column(
                    ...
                    children: [
                      Text(DateFormat('EEEE').format(today),
                          style: const TextStyle(color: Color(0xff909193), fontWeight: FontWeight.w400, fontStyle: FontStyle.normal, fontSize: 14.0),
                          textAlign: TextAlign.center),
              ...
              Row(
                ...
                children: [
                  const Text("New Arrivals",
                      style: TextStyle(color: Color(0xff000000), fontWeight: FontWeight.w700, fontStyle: FontStyle.normal, fontSize: 16.0),
                      textAlign: TextAlign.center),
                  GestureDetector(
                    onTap: () {
