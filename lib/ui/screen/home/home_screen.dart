            ...
            child: GestureDetector(
              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    requestRouter
                        .url(AccountConfig.userDetail.user.profile_image),
                    fit: BoxFit.cover,
                  ...
                  Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          Map<String, dynamic> images = json.decode(
                              newArrBook[index]['images'] ??
                                  '{"smallThumbnail": ""}');
                          return InkWell(
                            onTap: () => {GoRouter.of(context).push("/book-details", extra: newArrBook[index])},
                          child: Padding(
        ...
        items: [
          FlashyTabBarItem(
            icon: SizedBox(
              ...
              child: Image.asset(
                  'assets/icons/search.png'), // Replace with the actual asset path
            ),
            title: const Text(
              'Home',
          ...
          FlashyTabBarItem(
            icon: SizedBox(
              ...
              height: 24, // Adjust the height as needed
              child: Image.asset(
                  'assets/icons/mybook.png'), // Replace with the actual asset path
            ),
            title: const Text(
              'Reading',
              style: TextStyle(color: primary),
          ...
          FlashyTabBarItem(
            icon: SizedBox(
              ...
              height: 24, // Adjust the height as needed
              child: Image.asset(
                  'assets/icons/lent.png'), // Replace with the actual asset path
            ),
            title: const Text(
              'Catalog',
              style: TextStyle(color: primary),
          ...
          FlashyTabBarItem(
            icon: SizedBox(
              ...
              height: 24, // Adjust the height as needed
              child: Image.asset(
                  'assets/icons/refer.png'), // Replace with the actual asset path
            ),
            title: const Text(
              'Profile',
